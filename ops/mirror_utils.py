...
def get_mirror_object(context, obj, pivot, orientation):
    ...
    match (pivot, orientation):
        ...
        case ('ACTIVE', 'CURSOR'):
            mirror_object = create_empty_mirror_object(context, obj.location, orientation=context.scene.cursor.rotation_euler)
        ...
        case ('INDIVIDUAL', 'CURSOR'):
            individual = True
        case ('WORLD', 'LOCAL'):
            mirror_object = create_empty_mirror_object(context, (0.0, 0.0, 0.0), orientation=obj.rotation_euler)
        case ('WORLD', 'GLOBAL'):
            mirror_object = create_empty_mirror_object(context, (0.0, 0.0, 0.0))
        case ('WORLD', 'CURSOR'):
            mirror_object = create_empty_mirror_object(context, (0.0, 0.0, 0.0), orientation=context.scene.cursor.rotation_euler)
        case ('CURSOR', 'LOCAL'):
            mirror_object = create_empty_mirror_object(context, context.scene.cursor.location, orientation=obj.rotation_euler)
        case ('CURSOR', 'GLOBAL'):
            mirror_object = create_empty_mirror_object(context, context.scene.cursor.location)
        case ('CURSOR', 'CURSOR'):
            mirror_object = create_empty_mirror_object(context, context.scene.cursor.location, orientation=context.scene.cursor.rotation_euler)
